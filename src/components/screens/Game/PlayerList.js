...
export default ({ users, focusedUser }) => {
...
const CharacterBox = ({ highlight, background, children, nickname, votes, avatarURL }) => (
  <CharacterOutline>
